          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mt-6">
            <Link to="/#contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-primary-600 to-secondary-600 dark:from-primary-400 dark:to-secondary-400 text-white rounded-lg shadow-md w-full sm:w-auto"
                onClick={() => {
            ...
            >
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-[#1a9247] text-white rounded-lg shadow-md w-full sm:w-auto"
              >
                <div className="flex items-center justify-center">
                  <svg
