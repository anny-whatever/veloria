...
export default function WorldMap({ dots = [], lineColor = "#0ea5e9" }) {
  ...
  // Always use light mode with #F8F8FF background
  const svgMap = map.getSVG({
    radius: 0.22,
    color: "#00000040", // Light mode dots
    shape: "circle",
    backgroundColor: "#EDEDED", // Custom background color
  });
      ...
      >
        ...
        <defs>
          <linearGradient id="path-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#F8F8FF" stopOpacity="0" />
