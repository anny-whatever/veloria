  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "purple-lg":
          "0 20px 25px -5px rgba(139, 92, 246, 0.15), 0 10px 10px -5px rgba(139, 92, 246, 0.08)",
      ...
      backgroundImage: {
        ...
        "gradient-purple-dark":
          "linear-gradient(135deg, #7c3aed 0%, #4f46e5 50%, #9333ea 100%)",
        "dot-pattern":
          "radial-gradient(circle, rgb(139 92 246 / 0.1) 1px, transparent 1px)",
        "grid-pattern":
...
const buttonVariants = {
  variant: {
    primary:
      "bg-gradient-purple hover:bg-gradient-purple-dark text-white shadow-purple hover:shadow-purple-lg",
    secondary:
  ...
  return (
    <div
      className={cn(
        ...
        hover &&
          "transition-all duration-300 hover:-translate-y-1 hover:shadow-purple",
...
const CardTitle = ({ className, children, ...props }) => (
  <h3
    className={cn(
      "font-semibold leading-none tracking-tight text-white-900",
      className
    )}
    {...props}
  >
...
const CardDescription = ({ className, children, ...props }) => (
  <p className={cn("text-sm text-white-600", className)} {...props}>
    {children}
  </p>
);
...
const Typography = {
  H1: ({ className, children, ...props }) => (
    <h1
      className={cn(
        "text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight text-white-950",
        className
      )}
      {...props}
    >
  ...
  H2: ({ className, children, ...props }) => (
    <h2
      className={cn(
        "text-3xl md:text-4xl font-bold leading-tight tracking-tight text-white-900",
        className
      )}
      {...props}
    >
  ...
  H3: ({ className, children, ...props }) => (
    <h3
      className={cn(
        "text-2xl md:text-3xl font-semibold leading-tight tracking-tight text-white-900",
        className
      )}
      {...props}
    >
  ...
  H4: ({ className, children, ...props }) => (
    <h4
      className={cn(
        "text-xl md:text-2xl font-semibold leading-tight text-white-900",
        className
      )}
      {...props}
    >
  ...
  Lead: ({ className, children, ...props }) => (
    <p
      className={cn(
        "text-lg md:text-xl text-white-600 leading-relaxed",
        className
      )}
      {...props}
    >
  ...
  Body: ({ className, children, ...props }) => (
    <p
      className={cn("text-base text-white-600 leading-relaxed", className)}
      {...props}
    >
      {children}
    </p>
  ...
  Small: ({ className, children, ...props }) => (
    <p
      className={cn("text-sm text-white-500 leading-relaxed", className)}
      {...props}
    >
      {children}
    </p>
  ...
  return (
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        ...
        <div className="font-semibold text-white-900 mb-2">{title}</div>
        <div className="font-normal text-white-600 text-sm leading-relaxed">
          {description}
        </div>
        {children}
      </div>
    ...
    >
      {title && (
        <div className="px-4 py-3 border-b border-neutral-800 flex items-center justify-between">
          <span className="text-white-300 text-sm font-medium">{title}</span>
          <button
      ...
      <div className="p-4 overflow-x-auto">
        <pre className="text-sm text-white-300 font-mono leading-relaxed">
...
const GradientBackground = ({
  ...
  return (
    <div className={cn("relative", variants[variant], className)} {...props}>
      {children}
    </div>
  );
};
...
:root {
  ...
  /* Shadows */
  --shadow-purple: 0 10px 25px -5px rgb(139 92 246 / 0.1), 0 4px 6px -2px rgb(139
          92 246 / 0.05);
  --shadow-purple-lg: 0 20px 25px -5px rgb(139 92 246 / 0.15), 0 10px 10px -5px
      rgb(139 92 246 / 0.08);
  ...
  --gradient-purple-dark: linear-gradient(
    135deg,
    rgb(124 58 237) 0%,
    rgb(79 70 229) 50%,
    rgb(147 51 234) 100%
